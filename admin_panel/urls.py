...
urlpatterns = [
    ...
    path('admin-students-year/<int:year>', views.admin_students_by_year_view, name='admin-students-year'),
    ...
    path('admin-subject-grades', views.admin_subject_grades_view, name='admin-subject-grades'),
    path('admin-subject-grades/year/<int:year>', views.admin_subject_grades_by_year_view, name='admin-subject-grades-year'),
    path('admin-subject-grades/<int:pk>', views.admin_subject_grades_detail_view, name='admin-subject-grades-detail'),
    path('admin-export-grades/<int:pk>', views.admin_export_grades_csv, name='admin-export-grades'),
    path('admin-export-mastersheet/<int:year>', views.admin_export_mastersheet_csv, name='admin-export-mastersheet'),

    path('admin-announcements', views.admin_announcements_view, name='admin-announcements'),
    path('delete-announcement/<int:pk>', views.admin_delete_announcement_view, name='delete-announcement'),
